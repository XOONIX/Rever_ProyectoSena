    ...
    public class DatabaseService : DbContext
    {
        ...
        private void EntityConfiguration(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                entity.HasOne<Rol>().WithMany().HasForeignKey(u => u.IdRol);
            });
            ...
            modelBuilder.Entity<Barrio>(entity =>
            {
                ...
                entity.HasOne<Ciudad>().WithMany().HasForeignKey(u => u.IdCiudad);
                entity.HasOne<Localidad>().WithMany().HasForeignKey(u => u.IdLocalidad);
            });
            ...
            modelBuilder.Entity<Inmueble>(entity =>
            {
                ...
                entity.HasOne<TipoInmueble>().WithMany().HasForeignKey(u => u.IdTipo);
                entity.HasOne<Barrio>().WithMany().HasForeignKey(u => u.IdBarrio);
                entity.HasOne<Usuario>().WithMany().HasForeignKey(u => u.IdUsuario);
                entity.HasOne<EstadoPublicacion>().WithMany().HasForeignKey(u => u.IdEstado);
            });
            ...
            modelBuilder.Entity<Imagen>(entity =>
            {
                ...
                entity.HasOne<Inmueble>().WithMany().HasForeignKey(u => u.IdInmueble);
            });
            ...
            modelBuilder.Entity<InmuebleCaracteristica>(entity =>
            {
                ...
                entity.HasOne<Inmueble>().WithMany().HasForeignKey(u => u.IdInmueble);
                entity.HasOne<Caracteristica>().WithMany().HasForeignKey(u => u.IdCaracteristica);
            });
            ...
            modelBuilder.Entity<Contacto>(entity =>
            {
                ...
                entity.HasOne<Usuario>().WithMany().HasForeignKey(u => u.IdComprador).OnDelete(DeleteBehavior.Restrict);
                entity.HasOne<Usuario>().WithMany().HasForeignKey(u => u.IdVendedor).OnDelete(DeleteBehavior.Restrict);
                entity.HasOne<Inmueble>().WithMany().HasForeignKey(u => u.IdInmueble);
            });
        }
    }
